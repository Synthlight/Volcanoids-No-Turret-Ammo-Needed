...
namespace No_Turret_Ammo_Needed {
    ...
    public static class TurretAmmoPatch1 {
        ...
        public static readonly List<GUID> TURRET_AMMO_ITEMS = new() {
        ...
        public static MethodBase TargetMethod() {
            return typeof(WeaponReloaderAmmo).GetMethod(nameof(WeaponReloaderAmmo.LoadAmmo), BindingFlags.Public | BindingFlags.Instance | BindingFlags.FlattenHierarchy, null, new Type[] {typeof(InventoryBase), typeof(ItemDefinition), typeof(int)}, null);
        }
